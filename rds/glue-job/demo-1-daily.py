...
RelationalDB_node1697507787687 = glueContext.create_dynamic_frame.from_options(
    ...
    connection_options={
        ...
        "jobBookmarkKeys":["updated_time"],"jobBookmarkKeysSortOrder":"asc"
    },
...
AddCurrentTimestamp_node1697508640676 = RelationalDB_node1697507787687.gs_now(
    colName="partition_col",  dateFormat="%Y-%m-%d"
)

# Script generated for node S3 bucket
S3bucket_node2 = glueContext.getSink(
    path="s3://testbb-123/etl-output/demo-1-daily/",
    connection_type="s3",
...
S3bucket_node2.setCatalogInfo(catalogDatabase="gluedb", catalogTableName="demo-1-daily")
